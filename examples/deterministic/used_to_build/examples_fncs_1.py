...
def calc_next_coauthor_act(prev_act, strategy_name):
    ...
    # ---
    #
    # prev_act, 2-tuple of binary ints (0 or 1)
    #   The previous co-authorship actions of the focal player and 
    #   other player in that order. For example, (0, 1) says that,
    #   previously, the focal did not co-author the other's paper,
    #   but the other did co-author the focal's paper.
