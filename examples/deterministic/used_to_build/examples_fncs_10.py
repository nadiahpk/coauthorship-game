...
#
# updates:
# create_attributes_deterministic_graph() draw nicer edges
# print_attributes_deterministic_graph() draw nicer edges
...
def print_attributes_deterministic_graph(AG, prefix_out=None):
    ...
    subprocess.run(
        f"dot2tex --prog=neato --format=tikz --figonly --tikzedgelabel {prefix_out}.dot > {prefix_out}.tex",
        shell=True,
    )
